...
T = {
    "en": {
        ...
        "caption": "Combines live weather and simple AI advice to help you decide what to do in your field today.",
    ...
    "hi": {
        "language_label": "भाषा",
        "caption": "यह ऐप मौसम और आसान भाषा में एआई सलाह देकर आपको आज खेत में क्या करना है, यह तय करने में मदद करता है।",
    ...
    "te": {
        "language_label": "భాష",
        "caption": "ఈ యాప్ వాతావరణం మరియు సులభమైన భాషలో AI సలహా ఇచ్చి, ఈరోజు మీ పొలంలో ఏమి చేయాలో నిర్ణయించుకోవడంలో సహాయపడుతుంది.",
...
if run:
    ...
    with st.spinner(t["ai_spinner"]):
        ...
        system_prompt = (
            ...
            f"rainfall, days, etc.), keep the exact number but add a short plain-language "
